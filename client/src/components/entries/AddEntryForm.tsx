              ...
              <div className={cn("space-y-4", isNotesExpanded && "p-8 h-full overflow-y-auto")}>
                ...
                <div className="relative">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between">
                    <div className="text-xs text-gray-400 font-medium bg-white dark:bg-gray-800 px-3 py-1 rounded-full">
                    ...
                    <div className="group relative">
                      <button
                        ...
                        className={cn(
                          "p-3 rounded-full transition-all duration-200 relative shadow-lg",
                          isAnalyzing 
                      ...
                      {/* Tooltip */}
                      <div className="absolute bottom-full mb-3 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-20">
