...
export const QuickStatsGrid = () => {
  ...
  return (
    <section className="mb-8">
      <h3 className="text-4xl md:text-5xl font-light mb-8 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 bg-clip-text text-transparent tracking-tight">Your Progress</h3>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
