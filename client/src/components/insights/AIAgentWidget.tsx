  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="max-w-none w-full h-full p-0 gap-0 bg-white dark:bg-slate-900" aria-describedby="ai-agent-description">
        ...
        <div id="ai-agent-description" className="sr-only">
          Chat with ClarityLog's AI assistant for therapy guidance, case discussions, and professional development support.
        </div>
                ...
                {isLoading && (
                  <div className="flex gap-4 justify-start">
                    <div className="w-8 h-8 rounded-lg bg-gray-200 dark:bg-slate-700 flex items-center justify-center flex-shrink-0">
                      <svg className="h-4 w-4 text-gray-600 dark:text-slate-300" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M11 21h-1l1-7H7.5c-.88 0-.33-.75-.31-.78C8.48 10.94 10.42 7.54 13.01 3h1l-1 7h3.51c.4 0 .62.19.4.66C12.97 17.55 11 21 11 21z"/>
                      </svg>
                    </div>
