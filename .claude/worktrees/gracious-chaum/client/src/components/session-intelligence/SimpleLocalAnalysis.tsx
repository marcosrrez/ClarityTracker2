...
export function SimpleLocalAnalysis() {
  ...
  const toggleRecording = useCallback(async () => {
    if (isRecording) {
      ...
      try {
        ...
        // Initialize video element with better error handling
        if (videoRef.current) {
        ...
        // Start speech recognition with delay to ensure audio is ready
        setTimeout(() => {
  ...
  const startSpeechRecognition = useCallback(() => {
    ...
    if (!('webkitSpeechRecognition' in window) && !('SpeechRecognition' in window)) {
      ...
      setLastTranscript('Speech recognition not supported in this browser. Use Chrome or Edge.');
      return;
    }
    ...
    try {
      ...
      recognition.onresult = (event: any) => {
        ...
        if (finalTranscript.trim()) {
          ...
          console.log('✓ Captured final speech:', cleanTranscript);
        }
      ...
      recognition.onerror = (event: any) => {
        ...
        setLastTranscript(`Error: ${errorMessage}`);
      };
        ...
        if (isRecording) {
          ...
          setTimeout(() => {
            try {
              ...
              setLastTranscript('Speech recognition stopped - click Start Analysis again');
            }
          }, 1000);
        }
      };
      ...
      setLastTranscript('Speech recognition failed to start. Please use Chrome or Edge browser.');
    }
  }, [isRecording]);
